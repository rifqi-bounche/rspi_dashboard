...
with st.sidebar:
    ...
    # Filter Campaign — dipecah per hashtag
   ...
   # Filter Tanggal
    ...
    if 'timestamp' in df_db.columns:
        ...
        cur_range = st.date_input("Current Period", [min_date, max_date], key="cur")
...
col1.metric("👀 Total Views", f"{cur['total_views']:,}")
col2.metric("📝 Total Post",  f"{cur['total_post']:,}")
